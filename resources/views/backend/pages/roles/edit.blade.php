...
@section('title')
@lang('messages.role_edit') - @lang('messages.admin_panel')
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">@lang('messages.role_edit') - {{ $role->name }}</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('messages.dashboard')</a></li>
                    <li><a href="{{ route('admin.roles.index') }}">@lang('messages.list')</a></li>
                    <li><span>@lang('messages.role_edit')</span></li>
                </ul>
            </div>
        </div>
