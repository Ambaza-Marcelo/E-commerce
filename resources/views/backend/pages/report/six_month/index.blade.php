                ...
                <div class="card-body">
                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               @foreach($report3Months as $report3Month)
                               <tr>
                                    <td>{{ $loop->index+1 }}</td>
                                    <td></td>
                                   
                                    <td><a href="@if($report3Month->bon_entree){{ route('admin.stockins.show',$report3Month->bon_entree)}} @endif">{{ $report3Month->bon_entree }} </a></td>
                                    <td><a href="@if($report3Month->bon_sortie){{ route('admin.stockouts.show',$report3Month->bon_sortie)}} @endif">{{ $report3Month->bon_sortie }}</a></td>
                                    <td>{{ $report3Month->created_by }} </td>
                                    <td></td>
                                </tr>
                               @endforeach
                            </tbody>
